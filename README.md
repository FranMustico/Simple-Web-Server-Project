...
│   ├── Helpers/
│   │   └── WebsiteFileResolver.cs          # Sanitizer and path handler
│   ├── wwwroot/
...
A release version of the Simple Web Server Project is now available! This release includes:

- **Project Package**: A zip file containing the full project, packaged with the .NET framework.
- **Source Code**: A separate zip file with the complete source code.

### How to Use

1. **Download the Release**:
   - Navigate to the [Releases](https://github.com/FranMustico/Simple-Web-Server-Project/releases) page.
   - Download the `Simple-Web-Server-Project-1.0.0.zip` file.
...
3. **Run the Application**:
   ...
   - Locate the included `.exe` file.
   - Double-click the `.exe` file to start the web server.

4. **Access the Web Server**:
   - Open a browser and navigate to `http://localhost:5000`.

Enjoy using the Simple Web Server Project!
